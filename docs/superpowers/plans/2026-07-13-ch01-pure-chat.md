# StarryLink Ch01 纯对话客服 Implementation Plan
...
```bash
cd /Users/codemelo/starrylink-all/starrylink
uv init --python 3.12 --name starrylink --bare
...
app = FastAPI(title="StarryLink", version="0.1.0")
